...
int main() {
    ...
    int total = sum(&lista[0], len); // &lista[] indica que quermos o endereço de memoria 
                                     // do primeiro index da lista. e não o valor guardado 
                                     // no primeiro index
